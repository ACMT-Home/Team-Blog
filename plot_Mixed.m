...
plot(Xpt1(1,:),Xpt1(2,:),'-o','Color',C4,'linewidth',l_width,'MarkerSize',m_size);
hold on;
plot(xu1_5(1,:),xu1_5(2,:),'-^','Color',C9,'linewidth',l_width,'MarkerSize',m_size);
hold on
plot(x2,y2,'kx-','linewidth',l_width+1,'MarkerSize',m_size+2); 
hold on;
plot(xu2_1(1,:),xu2_1(2,:),'-s','Color',C1,'linewidth',l_width,'MarkerSize',m_size);
...
plot(Xpt2(1,:),Xpt2(2,:),'-o','Color',C4,'linewidth',l_width,'MarkerSize',m_size);
hold on;
plot(xu2_5(1,:),xu2_5(2,:),'-^','Color',C9,'linewidth',l_width,'MarkerSize',m_size);
hold on
plot(x3,y3,'kx-','linewidth',l_width+1,'MarkerSize',m_size+2); 
hold on;
plot(xu3_1(1,:),xu3_1(2,:),'-s','Color',C1,'linewidth',l_width,'MarkerSize',m_size);
...
plot(Xpt3(1,:),Xpt3(2,:),'-o','Color',C4,'linewidth',l_width,'MarkerSize',m_size);
hold on;
plot(xu3_5(1,:),xu3_5(2,:),'-^','Color',C9,'linewidth',l_width,'MarkerSize',m_size);
hold on
plot(x4,y4,'kx-','linewidth',l_width+1,'MarkerSize',m_size+2); 
hold on;
plot(xu4_1(1,:),xu4_1(2,:),'-s','Color',C1,'linewidth',l_width,'MarkerSize',m_size);
...
plot(Xpt4(1,:),Xpt4(2,:),'-o','Color',C4,'linewidth',l_width,'MarkerSize',m_size);
hold on;
plot(xu4_5(1,:),xu4_5(2,:),'-^','Color',C9,'linewidth',l_width,'MarkerSize',m_size);
xlim([-2 12]),ylim([-1 9]);
grid on;
set(gca,'Fontname', 'Times New Roman','FontSize',15,'FontWeight','bold');
xlabel('X(m)','FontName','Times New Roman','FontSize',16,'FontWeight','bold');
ylabel('Y(m)','FontName','Times New Roman','FontSize',16,'FontWeight','bold');
legend('Standard trajectory','the Proposed method','DR method','DKF method with attack detection','FontName','Times New Roman','FontSize',13,'LineWidth',1,'FontWeight','bold');
...
hold on;
plot(rmse_dkf_dectection,'-<','Color',C9,'linewidth',l_width,'MarkerSize',m_size);
...
legend('the Proposed method','EKF method','DKF method','DR method','DKF method with attack detection','FontName','Times New Roman','FontSize',13,'LineWidth',1,'FontWeight','bold');
...
figure(5)
plot(DoS_b2.*4,'.','Color',C1,'linewidth',l_width,'MarkerSize',14);
hold on;
plot(FDI_a2.*4,'+','Color',C8,'linewidth',l_width,'MarkerSize',8);
hold on;
plot(detec_node1.*4,'o','Color',C3,'linewidth',l_width,'MarkerSize',10);
hold on;
plot(DoS_b3.*3,'.','Color',C1,'linewidth',l_width,'MarkerSize',14);
hold on;
plot(FDI_a3.*3,'+','Color',C8,'linewidth',l_width,'MarkerSize',8);
hold on;
plot(detec_node2.*3,'o','Color',C3,'linewidth',l_width,'MarkerSize',10);
hold on;
plot(DoS_b4.*2,'.','Color',C1,'linewidth',l_width,'MarkerSize',14);
hold on;
plot(FDI_a4.*2,'+','Color',C8,'linewidth',l_width,'MarkerSize',8);
hold on;
plot(detec_node3.*2,'o','Color',C3,'linewidth',l_width,'MarkerSize',10);
hold on;
plot(DoS_b1,'.','Color',C1,'linewidth',l_width,'MarkerSize',14);
hold on;
plot(FDI_a1,'+','Color',C8,'linewidth',l_width,'MarkerSize',8);
hold on;
plot(detec_node4,'o','Color',C3,'linewidth',l_width,'MarkerSize',10);
hold on;
ylim([0 5]);
%pbaspect([4 1 1]);
set(gca,'Fontname', 'Times New Roman','FontSize',15,'FontWeight','bold');
xlabel('Time(s)','FontName','Times New Roman','FontSize',16,'FontWeight','bold');
ylabel('Agent number','FontName','Times New Roman','FontSize',16,'FontWeight','bold');
legend('DoS attack instants','FDI attack instants','Attack detected','FontName','Times New Roman','FontSize',13,'LineWidth',1,'FontWeight','bold');
